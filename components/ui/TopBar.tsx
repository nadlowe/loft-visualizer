...
export function TopBar() {
  ...
  const [prevDocName, setPrevDocName] = useState(doc.name);
  const inputRef = useRef<HTMLInputElement>(null);

  // Sync editedName with doc.name when it changes (e.g. from Undo)
  if (doc.name !== prevDocName) {
    setPrevDocName(doc.name);
