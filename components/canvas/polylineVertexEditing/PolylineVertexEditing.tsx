...
import { workPlaneTableToRendered } from "../render/renderWorkPlane";
...
import { useVertexWindowSelection } from "./useVertexWindowSelection";
...
export function PolylineVertexEditing({
  ...
  const { camera, raycaster, gl: renderer } = useThree();
  const {
    doc,
    updateEntity,
