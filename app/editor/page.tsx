...
import { DebugRefreshButton } from "@/components/ui/DebugRefreshButton";
...
import { getCurrentDocId } from "@/store/persistence";
      ...
      <div className="flex h-full pt-12">
        ...
        <div
          className={cn(
            ...
            cmd?.type === "DRAW_POLYLINE" && "cursor-crosshair"
          )}
        >
          <EditingBanner />
