...
import { faceRotate, faceBarrelRoll } from "../lib/face";
import { plane3New, plane3Rotate, plane3BarrelRoll } from "@/lib/plane3";
import { computeDefaultU } from "@/lib/vec3";
import { Plane3, Vec3, Face, Polygon } from "../lib/geomTypes";
